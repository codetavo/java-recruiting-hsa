...
import cl.accenture.javarecruitinghsa.service.impl.CategoriesServiceImpl;
...
public class CategoriesServiceTest {
    ...
    private ResponseEntity<CategoryThree> categoriesAPI;
	...
	public void setUp() throws Exception {
        ...
        categoriesServiceImpl = new CategoriesServiceImpl();
        categoriesAPI = new ResponseEntity<>(categoryThree, HttpStatus.OK);
    }

    @Test
	public void getCategoriesServiceCorrecto() throws Exception {
        Mockito.when(restTemplate.exchange(Mockito.anyString(), Mockito.<HttpMethod>any(), 
            Mockito.<HttpEntity<?>>any(),Mockito.<Class<CategoryThree>>any())).thenReturn(categoriesAPI);
		Whitebox.setInternalState(categoriesServiceImpl, "restTemplate", restTemplate);
		CategoryThree response = categoriesServiceImpl.getCategoriesService();
